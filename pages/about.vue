...
.social-link:hover {
  ...
  box-shadow: 0px 8px 16px rgba(55, 65, 81, 0.12);
}
...
.social-list:hover .social-link.instagram {
  left: calc((70px + 15px) * 1);
}

.social-list:hover .social-link.twitter {
  left: calc((70px + 15px) * 2);
}
